...
<section class="section-main">
	...
	<div class="fr_section1 row">
		<div class="fr_section1_left col-sm-12 col-md-6">
		...
		<div class="fr_section1_right col-sm-12 col-md-6">
		<canvas id="lamp-anim" class="lamp-anim" width="1500px" height="700px"></canvas>
		<!-- <img src="<?php echo get_template_directory_uri(); ?>/images/ellipse.png" alt="art dharabijuli"/>
		<img src="<?php echo get_template_directory_uri(); ?>/images/ellipse.png" alt="art dharabijuli"/>
		<img src="<?php echo get_template_directory_uri(); ?>/images/ellipse.png" alt="art dharabijuli"/> -->
		<h1  class="wow bounceIn" data-wow-delay="0.25s">OPEN<br>ALL WEEKDAYS<br>(8AM TO 8PM)</h1>
		<div class="low_text wow bounceIn" data-wow-delay="0.5s">
	...
	<div class="fr_section2 row">
		<div class="fr_section2_left col-md-6">
			<div class="card-wrapper">
				<img class="left wow" src="<?php echo get_template_directory_uri();?>/images/mod1.png" alt="dharabijuli" />
				<div class="fr_card wow bounceIn" data-wow-delay="0.5s">
